                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('users.update', $user) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="password" class="form-label">Password <small class="text-muted">(kosongkan
                                    ...
                                    <select class="form-select @error('id_departemen') is-invalid @enderror"
                                        ...
                                        @foreach ($departements as $dept)
                                            <option value="{{ $dept->id }}"
                                                {{ old('id_departemen', $user->detail->id_departemen ?? '') == $dept->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                        id="phone" name="phone"
                                        value="{{ old('phone', $user->detail->phone ?? '') }}" placeholder="08xxxxxxxxxx">
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('gender') is-invalid @enderror" id="gender"
                                        ...
                                        <option value="L"
                                            {{ old('gender', $user->detail->gender ?? '') == 'L' ? 'selected' : '' }}>
                                            Laki-laki</option>
                                        <option value="P"
                                            {{ old('gender', $user->detail->gender ?? '') == 'P' ? 'selected' : '' }}>
                                            Perempuan</option>
                                    </select>
                                    @error('gender')
                                        <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                rows="2">{{ old('description', $user->detail->description ?? '') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
